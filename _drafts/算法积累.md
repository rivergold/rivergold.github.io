...
**_Ref:_** [MMDetection: ops/nms](https://github.com/open-mmlab/mmdetection/blob/master/mmdet/ops/nms/src/nms_cpu.cpp)
...
Ground truth: $y$, $(N_{y}, 4)$

Predict: $\hat{y}$, $(N_{\hat{y}}, 4)$
