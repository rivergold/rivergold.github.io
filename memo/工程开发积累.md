...
[RUNOOB.com: MySQL](https://www.runoob.com/mysql/mysql-connection.html)
...
- :thumbsup:[stackoverflow: What is the default root pasword for MySQL 5.7](https://stackoverflow.com/a/33991229/4636081)
...
- :thumbsup:[Blog: CentOS 7 下 yum 安装 MariaDB](https://jaminzhang.github.io/mysql/yum-install-MariaDB-in-CentOS7/)

---

## Python MySQL

[w3schools.com: Python MySQL](https://www.w3schools.com/python/python_mysql_getstarted.asp)
...
- [stackoverflow: Authentication plugin 'caching_sha2_password' is not supported](https://stackoverflow.com/questions/50557234/authentication-plugin-caching-sha2-password-is-not-supported)
- [Github sanpingz/mysql-connector](https://github.com/sanpingz/mysql-connector)
...
- :thumbsup::thumbsup:[InfraSight Labs: Host Is Not Allowed to Connect to This MySQL Server](https://support.infrasightlabs.com/article/host-is-not-allowed-to-connect-to-this-mysql-server/)
